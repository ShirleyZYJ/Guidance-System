...
def main(args):
    ...
    segmentation_module.decoder.conv_last = nn.Conv2d(args.fc_dim // 4, 12, 1, 1, 0)
    #segmentation_module.decoder.conv_last.
    segmentation_module.decoder.conv_last_deepsup = nn.Conv2d(args.fc_dim // 4, 12, 1, 1, 0)
    ########
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size_per_gpu', default=11, type=int,
    ...
    parser.add_argument('--deep_sup_scale', default=0.0, type=float,
